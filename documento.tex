...
\especializacaoem{Engenharia de Software com DevOps}
...
\autor{Luciano Miranda Gadelha}
\titulo{Implementação de Fluxos CI/CD e Monitoramento em Ambientes de Nuvem: Uma Abordagem Baseada em Métricas DORA e Zero Trust}
\data{2026}
